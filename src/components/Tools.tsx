...
const TOOLS: {
  ...
  },
  {
    id: "pdf2img",
    title: "PDF to JPG",
    desc: "Convert each page to an image.",
    icon: ImageIcon,
  ...
  },
  {
    id: "text2pdf",
    title: "Text to PDF",
    desc: "Paste any text → instant PDF.",
    icon: Type,
  ...
  },
  {
    id: "watermark",
    title: "Watermark PDF",
    desc: "Add custom text watermark.",
    icon: Droplets,
  ...
  },
  {
    id: "excel2pdf",
    title: "Excel to PDF",
    desc: "Convert .xlsx sheets to PDF.",
  ...
  },
  {
    id: "rotate",
    title: "Rotate PDF",
    desc: "Rotate every page 90/180/270°.",
    icon: RotateCw,
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4">
          {TOOLS.map((t, i) => (
            ...
            >
              ...
              >
                <div
                  className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br ${t.accent} flex items-center justify-center mb-3 group-hover:scale-110 transition`}
                >
