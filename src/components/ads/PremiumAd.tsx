      ...
      {loading ? (
        <motion.div
          ...
          className={`w-full relative overflow-hidden rounded-3xl glass-strong border border-white/5 bg-white/[0.02] ${
            type === "hero"
              ? "h-32 max-w-4xl mx-auto"
              : type === "mid"
                ? "h-64 sm:h-80 max-w-2xl mx-auto"
        ...
        <motion.div
          ...
          className={`relative group overflow-hidden rounded-3xl glass-strong border border-white/10 bg-white/[0.03] transition-all duration-500 hover:shadow-[0_0_30px_rgba(139,92,246,0.15)] hover:border-primary/30 flex items-center justify-center text-center ${
            type === "hero"
              ? "h-32 sm:h-40 max-w-4xl mx-auto p-6"
              : type === "mid"
                ? "h-64 sm:h-80 max-w-2xl mx-auto p-8"
              ...
              <div className="flex items-center gap-6 text-left">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-sm text-muted-foreground">
                    This horizontal banner area is reserved for high-converting sponsors. Blends
            ...
            {type === "mid" && (
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-sm mb-6">
                  A medium rectangle ad slot perfect for showcasing premium tools, software, or
                  services to your engaged audience.
                </p>
