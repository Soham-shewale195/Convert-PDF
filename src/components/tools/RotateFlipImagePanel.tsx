            ...
            <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 py-2.5 rounded-xl text-sm font-medium transition-all glass hover:bg-white/10"
                >
                  ↺ Left
                </button>
                <button
                  onClick={() => setAngle(0)}
                  className="flex-[0.5] py-2.5 rounded-xl text-sm font-medium transition-all glass hover:bg-white/10 text-muted-foreground"
                >
                  Reset
                </button>
                <button
            ...
            <div>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 py-2.5 rounded-xl text-sm font-medium transition-all ${flipH ? "btn-gradient shadow-[0_0_15px_rgba(139,92,246,0.2)]" : "glass hover:bg-white/10"}`}
                >
                  ↔ Horizontal
                </button>
                <button
                  onClick={() => setFlipV((f) => !f)}
                  className={`flex-1 py-2.5 rounded-xl text-sm font-medium transition-all ${flipV ? "btn-gradient shadow-[0_0_15px_rgba(139,92,246,0.2)]" : "glass hover:bg-white/10"}`}
                >
                  ↕ Vertical
                </button>
              </div>
