...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Terms and conditions for using Convert PDF's browser-based document tools.",
      },
    ],
    links: [{ rel: "canonical", href: "https://converttpdf.com/terms" }],
  }),
  component: Terms,
});
  ...
  return (
    <PageLayout title="Terms & Conditions">
      <InfoPageSchema
        ...
        description="Terms and conditions for using Convert PDF's browser-based document tools."
        urlPath="/terms"
      ...
      <p>
        By accessing and using Convert PDF, you accept and agree to be bound by the terms and
      ...
      <p>
        Convert PDF provides browser-based document and image conversion tools. We do not provide
        guarantees regarding the absolute accuracy of the conversion output, especially for complex
        formatting, scanned documents, or proprietary fonts.
      </p>

      <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">
        3. Fair Use & Restrictions
      </h2>
      <p>
        Our service is provided for personal and professional use. You agree not to reverse
        engineer, scrape, or programmatically abuse the platform. While the service handles
        processing locally on your device, we reserve the right to restrict access to users who
        abuse our infrastructure.
      </p>

      <h2 className="text-xl font-semibold text-foreground mt-8 mb-4">4. Intellectual Property</h2>
      <p>
        You retain full ownership and copyright of any documents you process using Convert PDF. We
        make no claim of ownership over your files. The Convert PDF website, design, logo, and code
        are the intellectual property of Convert PDF.
      </p>
      ...
      <p>
        ...
        be reflected on this page with an updated revision date. Continued use of Convert PDF after
