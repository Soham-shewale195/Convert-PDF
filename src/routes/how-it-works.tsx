...
export const Route = createFileRoute("/how-it-works")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Learn the technology behind our private, in-browser document conversion process.",
      },
    ],
    links: [{ rel: "canonical", href: "https://converttpdf.com/how-it-works" }],
  }),
  ...
  return (
    <PageLayout title="How It Works">
      <p className="text-lg mb-8">
        Convert PDF uses cutting-edge browser technologies to process your files locally. Here is a
        breakdown of how the magic happens.
      </p>
      ...
      <div className="space-y-8 mt-10">
        <div className="glass rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              When you drag and drop a file into Convert PDF, it doesn't go anywhere. Instead of
              uploading the file to a remote server, your browser simply reads the file into its own
              local memory.
            </p>
          </div>
        </div>
        ...
        <div className="glass rounded-2xl p-6 sm:p-8 flex flex-col md:flex-row gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Once the processing is complete, the browser immediately generates the output file and
              prompts a download. Because there are no servers involved, you don't have to wait for
              the file to be uploaded or downloaded across the internet.
            </p>
          </div>
        </div>
      </div>
      ...
      <ul className="list-disc pl-6 space-y-2 mt-4">
        ...
        <li>
          ...
          as your computer can process them.
        </li>
      </ul>
    </PageLayout>
  );
